...
public class AxonConfig {
    ...
    public MongoTemplate axonMongoTemplate(){
        return DefaultMongoTemplate.builder()
                .mongoDatabase(this.mongo(), mongoDatabase)
                .build();
    }

    @Bean
    public TokenStore tokenStore(Serializer serializer) {
        return MongoTokenStore.builder().mongoTemplate(this.axonMongoTemplate())
    ...
    @Bean
    public EmbeddedEventStore eventStore(EventStorageEngine eventStorageEngine, AxonConfiguration axonConfig){
        return EmbeddedEventStore.builder().storageEngine(eventStorageEngine)
                .messageMonitor(axonConfig.messageMonitor(EventStore.class, "eventStore")).build();
